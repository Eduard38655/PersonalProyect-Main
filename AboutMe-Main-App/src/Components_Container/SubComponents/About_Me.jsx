...
function About_Me(params) {
 ...
 <div className={Styles.About_Me_Text}>
    ...
    <br />
<p>
Desarrollador Full Stack, especializado en la creación de aplicaciones web dinámicas, intuitivas y de alto 
rendimiento. Mi pasión radica en convertir ideas complejas en soluciones digitales elegantes y funcionales,
utilizando tecnologías modernas y mejores prácticas de desarrollo.
</p>

<br />

<p>
Poseo un fuerte dominio tanto del frontend como del backend.Me encanta enfrentar nuevos desafíos y
 estoy en constante aprendizaje para mantenerme al día con las 
 últimas tendencias tecnológicas y ofrecer productos de la más alta calidad.
 </p>
 <br />
 <div className={Styles.Social_Media_Container}>
   
  
  <Link to="https://www.linkedin.com/notifications/?filter=all" target="_blank">
