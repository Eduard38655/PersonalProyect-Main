...
<div className={Styles.Proyectos_SubContainer}>
 ...
 {proyectos.map((proyecto) => (
        ...
        <div className={Styles.Proyectos_Botones}>
                <button className={Styles.Demo}><a href={proyecto.enlace_demo} target="_blank" rel="noopener noreferrer">Ver Demo</a></button>
                
                <button className={Styles.Repositorio}>
                    <a href={proyecto.enlace_codigo} target="_blank" rel="noopener noreferrer">
                    <i className="fa-brands fa-github"></i> Repositorio</a>
                </button>
